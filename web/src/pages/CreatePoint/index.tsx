...
interface IBGECityResponse { // CITY
    nome: string;
}

const CreatePoint = () => {
    const [items, setItems] = useState<Item[]>([]); //Armazenar informação no componente
    ...
    useEffect(() => { 
        //RETORNA A POSIÇÃO INICIAL ASSIM QUE ABRIR APLICAÇÃO
    ...
    useEffect(() => {
        api.get('items').then(response => { //Dados dos items
    ...
    function handleInputChange(event: ChangeEvent<HTMLInputElement>) {
        ...
        setFormData({ ...formData, [name]: value }); //...formData Copiar tudo oq tem dentro do objeto
    }
